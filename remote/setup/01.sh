...
# Add the new user (with home directory and sudo access)
adduser --gecos "" --disabled-password "${USERNAME}"
usermod -aG sudo "${USERNAME}"


# Copy SSH keys from the ubuntu user (instead of root)
...
# Replace the existing Caddy repository addition with these commands
